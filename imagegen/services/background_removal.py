...
class BackgroundRemovalService:
    def __init__(self, models: MattingModelRegistry, storage: ImageStorage):
        self.models = models
    ...
    def get_for_item(self, item_id: str, *, user_id: int) -> BackgroundRemovalRun | None:
        return db.session.scalar(
            select(BackgroundRemovalRun)
            .options(selectinload(BackgroundRemovalRun.results))
            .where(
                BackgroundRemovalRun.source_item_id == item_id,
