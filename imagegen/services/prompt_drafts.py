...
class PromptDraftParser:
    @staticmethod
    def system_prompt(*, translate_to_english: bool, workspace_kind: str = "image") -> str:
        target = (
        ...
        workflow = (
            "当前任务是帧动画。提示词必须同时明确固定不变的主体、场景、构图、镜头、光线、材质和色彩，以及完整动作从起点到终点的变化；要求每次只输出一张完整画面，禁止分镜表、拼图和 Sprite Sheet。"
