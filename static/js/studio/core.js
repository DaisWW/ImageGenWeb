  ...
  class StudioApp {
    ...
    cacheElements() {
      ...
      this.el = {
        ...
        maskEditPreview: byId("maskEditPreview"),
        ...
        detailImagePreviewButton: byId("detailImagePreviewButton"),
        detailList: byId("detailList"),
        detailPrompt: byId("detailPrompt"),
        detailReferences: byId("detailReferences"),
        detailMaskPreviewButton: byId("detailMaskPreviewButton"),
