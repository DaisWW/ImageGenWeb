...
class TestAdminAndMaintenance(PlatformTestCase):
    ...
    def test_admin_channel_config_is_encrypted_versioned_and_hot_reloaded(self):
        ...
        self.assertTrue(initial["channels"][0]["capabilities"]["supports_mask"])
        ...
        initial["channels"][0]["capabilities"]["supports_mask"] = False
        ...
        self.assertFalse(saved["channels"][0]["capabilities"]["supports_mask"])
        ...
        self.assertFalse(channel.capabilities.supports_mask)
